...
namespace ProjectD
{
    public class UILineRenderer : Graphic
    {
        ...
        {
            //if (points.Contains(position) == false)
            {
                points.Add(point);
                SetVerticesDirty();
            }
        ...
        public void AddRectanglePoint()
        {
            points[4] = points[0];
            SetVerticesDirty();
        }

        public void SetLastPoint(Vector2 point)
        {
            if (points.Count > 0)
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            for (int i = 0; i < points.Count - 1; i++)
            {
                ...
                // between line segments using the end position of
        ...
        /// </summary>
        /// <param name="point1">The starting position of the segment</param>
        /// <param name="point2">The endint position of the segment</param>
